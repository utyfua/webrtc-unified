...
- - [Server](#server)
- - [Client](#client)
- [API reference(client)](#api-referenceclient)
...
- - - [addIceServer](#rtcunifiedaddiceservericeserver)
- - - [setConnect](#rtcunifiedsetconnectsenddata)
- - - [joinRoom](#rtcunifiedjoinroomroomid--default)
- - - [leaveRoom](#rtcunifiedleaveroom)
- - - [setMedia](#rtcunifiedsetmediaoptions)
- - - [getMedia](#rtcunifiedgetmediatype)
- - - [createStream](#rtcunifiedcreatestreamoptions)
